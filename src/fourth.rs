...
mod test {
    ...
    fn push_pop_back() {
        ...
        assert_eq!(&mut *list.peek_back_mut().unwrap(), &mut 6);
        assert_eq!(&mut *list.peek_front_mut().unwrap(), &mut 5);
    }
    ...
    fn iterators() {
        ...
        assert_eq!(itr.next(), Some(7));
        assert_eq!(itr.next_back(), Some(5));
        assert_eq!(itr.next_back(), Some(6));
